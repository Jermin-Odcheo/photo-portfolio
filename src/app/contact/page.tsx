                    ...
                    <div className="md:col-span-2 space-y-10">
                        <div>
                            ...
                            <p className="text-white/50 text-sm leading-relaxed">
                                Feel free to send a message using the form.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                {[
                                    { label: "LinkedIn", href: "https://www.linkedin.com/in/jerminodcheo/"},
                                    { label: "GitHub", href: "https://github.com/Jermin-Odcheo"},
                                ].map(({ label, href }) => (
                                    <a
                                        target="_blank"
                                        key={label}
